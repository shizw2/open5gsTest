...
void dsMakeMachineID(/*char *szSysInfo*/)
{
    char szSysInfo[MAX_SYS_INFO_LENGTH] = { 0 };/*生成szSysInfo的算法可以修改*/
    ...
    if(fwrite(szSysInfo,sizeof(unsigned char),iSystemInfoLen, MachineFile)!=iSystemInfoLen)
	{
